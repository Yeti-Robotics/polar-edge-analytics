...
create table public.stand_form (
    ...
    auto_notes_missed     smallint not null default 0,
    auto_shuttle_notes           smallint not null default 0,
    teleop_amp_notes        smallint not null default 0,
    teleop_speaker_notes    smallint not null default 0,
    teleop_amped_speaker_notes smallint not null default 0,
    teleop_notes_missed     smallint not null default 0,
    teleop_shuttle_notes           smallint not null default 0,
